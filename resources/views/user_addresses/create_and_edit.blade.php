            ...
            <div class="col-md-10 offset-lg-1">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('user_addresses.index') }}" class="float-right">返回</a>
                    </div>
                    <div class="card-body">
                        @if(count($errors) > 0)
                        ...
                        @if ($address->id)
                        <form class="form-horizontal" role="form" action="{{ route('user_addresses.update',
                        ['user_address'=>$address->id]) }}" method="POST">
                        {{ method_field('PUT') }}
                        @else
                        ...
                        @endif
                            ...
                            :init-value="{{ json_encode([old('province',$address->province),
                            old('city',$address->city),old('district',$address->district)]) }}">
                            ...
                            <div class="form-group row ">
                                <label class="col-form-label text-md-right col-sm-2">手机号</label>
                                <div class="col-sm-9">
